...
if __name__ == '__main__':
    ...
    if args.test:
        ...
        model = PPO.load(zip, env, verbose=1, tensorboard_log=log,callback=[checkpoint_callback])
    else:
        model = PPO('MlpPolicy', env, verbose=1, tensorboard_log=log,callback=[checkpoint_callback])
