...
checkpoint_callback = CheckpointCallback(save_freq=20000, save_path='/home/josebarreiros/rl/tmp/RlCitoStationBoxPushing/model_checkpoints/')
debug=args.debug #True

if __name__ == '__main__':
    num_cpu = 12 if not args.test else 2
    if not args.train_single:
        env = make_vec_env("RlCitoStationBoxPushing-v0",
                        n_envs=num_cpu,
                        seed=0,
